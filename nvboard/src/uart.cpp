...
UART::UART(SDL_Renderer *rend, int cnt, int init_val, int ct, int x, int y, int w, int h) : Component(rend, cnt, init_val, ct),
                                                                                            tx_state(0), rx_state(0), divisor(432), need_update_gui(false)
{
...
{ // everything is done in update_state()
}
